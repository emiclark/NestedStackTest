...
class ViewController: UIViewController {
    ...
    func setupViews() {
        ...
        stack1.addSubview(label1)
        stack1.addSubview(label2)
        stack1.addSubview(label3)
        
        // add remaining views
        bkgView1.addSubview(stack1)
        view.addSubview(bkgView1)
    ...
    func setupLabels() {
        ...
        label1.anchor(top: stack1.topAnchor, leading: stack1.leadingAnchor, trailing: stack1.trailingAnchor, bottom: nil, padding: .init(top: 25, left: 0, bottom: 0, right: 10))
        
        label2.anchor(top: label1.bottomAnchor, leading: stack1.leadingAnchor, trailing: stack1.trailingAnchor, bottom: nil, padding: .init(top: 10, left: 10, bottom: 0, right: 10))
        
        label3.anchor(top: label2.bottomAnchor, leading: stack1.leadingAnchor, trailing: stack1.trailingAnchor, bottom: stack1.bottomAnchor, padding: .init(top: 20, left: 20, bottom: 0, right: 20))
        
        label4.anchor(top: stack1.bottomAnchor, leading: view.leadingAnchor, trailing: view.trailingAnchor, bottom: nil, padding: .init(top: 8, left: 5, bottom: 0, right: 5))
    }
    
    func constrainObjects() {
        
        // constrain bkgView to view with padding
        bkgView1.anchor(top: view.topAnchor, leading: view.leadingAnchor, trailing: view.trailingAnchor, bottom: label3.bottomAnchor, padding: .init(top: 25, left: 10, bottom: 0, right: 10) )
        
        // constrain stackView inside bkgView - so that stackView can have a background color
        stack1.anchor(top: bkgView1.topAnchor, leading: bkgView1.leadingAnchor, trailing: bkgView1.trailingAnchor, bottom: bkgView1.bottomAnchor, padding: .init(top: 10, left: 16, bottom: 0, right: 16))
